...
(9, 'Sidebar', 'sidebar', '300x600', 'image', '#', 'uploads/ads/728x90.jpg', '', 1),
...
(142, 'mobile_apps_api_secret_key', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'),
...
(148, 'admob_banner_ads_id', 'ca-app-pub-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxe'),
(149, 'admob_interstitial_ads_id', 'ca-app-pub-xxxxxxxxxxxxxxxxxxx/xxxxxxxxxxxxxxe'),
...
(183, 'tmbd_api_key', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'),
...
CREATE TABLE `cron` (
  ...
  `mannan@spagreen.net_from` varchar(250) DEFAULT NULL,
  `mannan@spagreen.net` varchar(250) DEFAULT NULL,
...
(1, 'Sports', '', 'All Sport TV Channel', 1);
...
CREATE TABLE `star` (
  ...
  `star_name` varchar(200) DEFAULT NULL,
...
(1, 'admin_name', 'admin-name', 'admin_username', 'admin_email', 'admin_password', 1, 'admin', NULL, 'default', '#16163F', '2019-01-01 00:00:00', '2019-01-01 00:00:00', 1);
...
CREATE TABLE `videos` (
  ...
  `last_ep_added` datetime DEFAULT '2019-01-01 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `config`
  MODIFY `config_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=199;

--
-- AUTO_INCREMENT for table `country`
--
ALTER TABLE `country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `video_type`
  MODIFY `video_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
